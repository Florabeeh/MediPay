    ...
    <Shell {...shellProps}>
      ...
      <div style={s.pg}>
        ...
        <div style={s.rcpCard}>
          ...
          <p style={{ fontSize: 10, color: palette.muted, textAlign: "center", wordBreak: "break-all", marginTop: 4 }}>Tx: {receipt?.id}</p>
          {receipt?.walletAddr && <p style={{ textAlign:"center", marginTop:4 }}><a href={"https://testnet.arcscan.app/address/" + receipt.walletAddr + "?tab=token_transfers"} target="_blank" rel="noreferrer" style={{ fontSize:10, color:"#20b2aa", textDecoration:"none", fontWeight:600 }}>View on ARC Explorer</a></p>}
        </div>
            ...
            <div key={r.id} style={{ ...s.histCard, ...(r.status === "pending" ? { borderLeft: "4px solid #f5c85b" } : { borderLeft: "4px solid #3fb7a3" }) }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {r.walletAddr && <a href={"https://testnet.arcscan.app/address/" + r.walletAddr + "?tab=token_transfers"} target="_blank" rel="noreferrer" style={{ fontSize: 10, color: palette.brandDeep, textDecoration: "none", marginTop: 2, display: "block" }}>View on ARC Explorer</a>}
