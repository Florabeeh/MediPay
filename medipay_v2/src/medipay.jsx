    ...
    <Shell {...shellProps}>
      ...
      <div style={s.pg}>
        ...
        <div style={s.rcpCard}>
          ...
          <p style={{ fontSize: 10, color: palette.muted, textAlign: "center", wordBreak: "break-all", marginTop: 4 }}>Tx: <a href={"https://testnet.arcscan.app/tx/" + receipt?.id} target="_blank" rel="noreferrer" style={{ color:"#20b2aa", textDecoration:"none" }}>{receipt?.id}</a></p>
        </div>
            ...
            <div key={r.id} style={{ ...s.histCard, ...(r.status === "pending" ? { borderLeft: "4px solid #f5c85b" } : { borderLeft: "4px solid #3fb7a3" }) }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {r.id && <a href={"https://testnet.arcscan.app/tx/" + r.id} target="_blank" rel="noreferrer" style={{ fontSize: 10, color: palette.brandDeep, textDecoration: "none", marginTop: 2, display: "block" }}>View on ARC Explorer</a>}
