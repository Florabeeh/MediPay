      ...
      <div style={s.pg}>
        ...
        <div style={s.rcpCard}>
          ...
          <p style={{ fontSize: 10, color: palette.muted, textAlign: "center", wordBreak: "break-all", marginTop: 4 }}>
            Tx: <a href={"https://testnet.arcscan.app/tx/" + (receipt?.arcTxHash || receipt?.id)} target="_blank" rel="noreferrer" style={{ color:"#20b2aa", textDecoration:"none" }}>{receipt?.arcTxHash || receipt?.id}</a>
          </p>
        </div>
